...
Auto-update needs **only** `updater.json` at that URL — no website code change required. The
human-facing downloads page would need a new SubStreak card/section only if you want a download
button listed there.
